...
class Dictionary(page.Page):
    ...
    def serve(cls, req):
        ...
        jp.Div(a=div,
               text="Get the definition of English words instantly as you type.",
               classes="text-lg")
        ...
        output_div = jp.Div(a=div,
                            classes="m-2 p-2 text-lg border-2 border-gray-500 h-40")

        input_box = jp.Input(a=input_div,
                             placeholder="Type in a word here...",
                             outputdiv=output_div,
                             classes="m-2 bg-gray-100 border-2 border-gray-500 rounded w-64 "
        ...
        #           text="Get Definition",
        #           classes="m-2 py-2 px-4 text-gray-700 bg-gray-300 border-2 border-gray-400",
